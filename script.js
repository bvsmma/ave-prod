...
var translations = {
  ru: {
    ...
    'features.description': 'Почему клиенты выбирают ave tool',
    ...
    'contact.ctaTitle': 'Получить доступ',
    'contact.subtitle': 'Присоединяйтесь к нашему сообществу',
    'contact.joinDiscord': 'Discord',
    'contact.writeTelegram': 'Telegram',
    'contact.workHoursLine': 'Пн-Вс, без выходных | Ночные релизы — по запросу',
  ...
  en: {
    ...
    'features.description': 'Why clients choose ave tool',
    ...
    'contact.ctaTitle': 'Get Access',
    'contact.subtitle': 'Join our community',
    'contact.joinDiscord': 'Discord',
    'contact.writeTelegram': 'Telegram',
    'contact.workHoursLine': 'Mon-Sun, no days off | Night releases — on request',
